import { BinaryBitmap, DecodeHintType, Reader, Result } from '@zxing/library';
...
export declare class BrowserCodeReader {
     ...
     */
    findDeviceById(deviceId: string): Promise<MediaDeviceInfo | undefined>;
    /**
     ...
     */
    decodeFromInputVideoDeviceContinuously(deviceId: string, videoSource: string | HTMLVideoElement | undefined, callbackFn: DecodeContinuouslyCallback): Promise<void>;
    /**
     ...
     * @memberOf BrowserCodeReader
     */
    decodeFromVideoDevice(deviceId: string | null, previewElem: string | HTMLVideoElement | undefined, callbackFn: DecodeContinuouslyCallback): Promise<void>;
    /**
     ...
     * @memberOf BrowserCodeReader
     */
    decodeFromConstraints(constraints: MediaStreamConstraints, previewElem: string | HTMLVideoElement | undefined, callbackFn: DecodeContinuouslyCallback): Promise<void>;
    /**
     ...
     * @memberOf BrowserCodeReader
     */
    decodeFromStream(stream: MediaStream, preview: string | HTMLVideoElement | undefined, callbackFn: DecodeContinuouslyCallback): Promise<void>;
    /**
    ...
    createVideoElement(videoThingy?: HTMLVideoElement | string): HTMLVideoElement;
    /**
     * Sets a HTMLVideoElement for scanning or creates a new one.
     *
     * @param videoElem The HTMLVideoElement to be set.
     */
    prepareVideoElement(videoElem?: HTMLVideoElement | string): HTMLVideoElement;
    /**
     ...
     */
    protected attachStreamToVideo(stream: MediaStream, preview?: string | HTMLVideoElement): Promise<HTMLVideoElement>;
    /**
     *
     * @param videoElement
     */
