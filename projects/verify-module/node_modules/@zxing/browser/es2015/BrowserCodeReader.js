...
export class BrowserCodeReader {
     ...
     */
    constructor(reader, timeBetweenScansMillis = 500, hints) {
        this.reader = reader;
    ...
    decodeFromStream(stream, preview, callbackFn) {
        return __awaiter(this, void 0, void 0, function* () {
            this.reset();
            const video = yield this.attachStreamToVideo(stream, preview);
    ...
    createVideoElement(videoThingy) {
     ...
     */
    attachStreamToVideo(stream, preview) {
        return __awaiter(this, void 0, void 0, function* () {
