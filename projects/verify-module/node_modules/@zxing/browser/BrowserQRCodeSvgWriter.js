...
var BrowserQRCodeSvgWriter = /** @class */ (function () {
    ...
    BrowserQRCodeSvgWriter.prototype.write = function (contents, width, height, hints) {
        ...
        if (hints !== null) {
            if (hints.get(library_1.EncodeHintType.ERROR_CORRECTION)) {
                var stringHints = hints.get(library_1.EncodeHintType.ERROR_CORRECTION).toString();
                errorCorrectionLevel = library_1.QRCodeDecoderErrorCorrectionLevel.fromString(stringHints);
            }
            if (hints.get(library_1.EncodeHintType.MARGIN)) {
                quietZone = parseInt(hints.get(library_1.EncodeHintType.MARGIN).toString(), 10);
            }
        }
