...
var BrowserCodeReader = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.reset();
                        return [4 /*yield*/, this.attachStreamToVideo(stream, preview)];
                    case 1:
                        video = _a.sent();
    ...
    BrowserCodeReader.prototype.createVideoElement = function (videoThingy) {
        ...
        if (typeof videoThingy === 'string') {
            return this.getMediaElement(videoThingy, 'video');
        }
     ...
     */
    BrowserCodeReader.prototype.prepareVideoElement = function (videoElem) {
        var videoElement = this.createVideoElement(videoElem);
        // Needed for iOS 11
    ...
    BrowserCodeReader.prototype.decodeOnce = function (element, retryIfNotFound, retryIfChecksumOrFormatError) {
        ...
        var loop = function (resolve, reject) {
            if (_this._stopAsyncDecode) {
                reject(new library_1.NotFoundException('Video stream has ended before any code could be detected.'));
                _this._stopAsyncDecode = false;
                return;
            }
            try {
                ...
                var ifNotFound = retryIfNotFound && e instanceof library_1.NotFoundException;
                var isChecksumOrFormatError = e instanceof library_1.ChecksumException || e instanceof library_1.FormatException;
    ...
    BrowserCodeReader.prototype.decodeContinuously = function (element, callbackFn) {
        ...
        var loop = function () {
            if (_this._stopContinuousDecode) {
                _this._stopContinuousDecode = false;
                return;
            }
            try {
                var result = _this.decode(element);
                ...
                var isChecksumOrFormatError = e instanceof library_1.ChecksumException || e instanceof library_1.FormatException;
                var isNotFound = e instanceof library_1.NotFoundException;
    ...
    BrowserCodeReader.prototype.createCaptureCanvas = function (mediaElement) {
        ...
        var getDimensions = function () {
            if (mediaElement instanceof HTMLVideoElement) {
                var width_1 = mediaElement.videoWidth;
                var height_1 = mediaElement.videoHeight;
                return { width: width_1, height: height_1 };
            }
            else if (mediaElement instanceof HTMLImageElement) {
                var width_2 = mediaElement.naturalWidth || mediaElement.width;
                var height_2 = mediaElement.naturalHeight || mediaElement.height;
                return { width: width_2, height: height_2 };
            }
            throw new Error('Couldn\'t find the Source\'s dimentions!');
        };
        var _a = getDimensions(), width = _a.width, height = _a.height;
     ...
     */
    BrowserCodeReader.prototype.attachStreamToVideo = function (stream, preview) {
        return __awaiter(this, void 0, void 0, function () {
            var videoElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        videoElement = this.prepareVideoElement(preview);
